                        ...
                        <Card.Root>
                            ...
                            <Card.Footer>
                                <div class="text-muted-foreground flex items-center space-x-2">
                                    ...
                                    <span class="text-sm"
                                        >{organization.platformCount} platforms</span
                                    >
                                </div>
                            </Card.Footer>
                        </Card.Root>
            ...
            {:else}
                <Card.Root class="text-center col-span-2">
                    <Card.Header>
                        ...
                        <Card.Description>
                            You haven't created or joined any organizations. Start by creating a new
                            one!
                        </Card.Description>
                    </Card.Header>
                    <Card.Content>
                        <Button href="/dashboard/organization/create"
            ...
            {:else}
                <Card.Root class="text-center col-span-2">
                    <Card.Header>
                        ...
                        <Card.Description>
                            You're not moderating any platforms yet. They will appear here once
                            you're assigned.
                        </Card.Description>
                    </Card.Header>
                    ...
                    <li>
                        <Card.Root>
                            <Card.Header>
                                <Card.Title class="text-lg font-medium">{platform.name}</Card.Title>
                                <Card.Description
                                    >You've been invited to moderate this platform</Card.Description
                                >
                            </Card.Header>
                            <Card.Content>
                                <InviteForm data={data.inviteForm} platformId={platform.id}
                                ></InviteForm>
                            </Card.Content>
                        </Card.Root>
                    </li>
